...
import {
  deletePurpose,
  getPurposes,
  getPurposesByWorkTypeId,
} from "../../../lib/api/purposesApi";
...
export default function PurposePage() {
  ...
  useEffect(() => {
    if (isSuccess && data) {
      toast.success(data.message, { toastId: "fetch-purposes-success" });
    }
  ...
  const deleteMutation = useMutation({
    mutationFn: (id: string) => deletePurpose(id),
    onSuccess: () => {
      toast.success("Xóa mục đích quy đổi thành công!");
